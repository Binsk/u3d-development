...
if (not instance_exists(obj_animation_controller)){
	instance_create_depth(0, 0, 1, obj_animation_controller);	// Allow auto-handling animation updates
	instance_create_depth(0, 0, 1, obj_render_controller);		// Allow auto-handling rendering updates
	instance_create_depth(0, 0, 1, obj_collision_controller);
}
...
light_directional.get_shadow_eye().set_size(24, 24);
