...
material_alpha -= frame_delta;

// Move box up and spin:
body.set_position(vec_mul_scalar(Node.AXIS_UP, frame_delta), true);
body.set_rotation(veca_to_quat(veca(0, 1, 0, degtorad(180 * frame_delta))), true);
